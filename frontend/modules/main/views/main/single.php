        ...
        <div class="post-content-body">
            ...
            <div class="row mb-5">
                <div class="col-md-12 mb-4 element-animate">
                    <img src="/frontend/web/sourse/images/img_7.jpg" alt="Image placeholder" class="img-fluid">
                </div>
        ...
        <div class="sidebar-box">
            ...
            <div class="post-entry-sidebar">
                <ul>
                    <li>
                        <a href="">
                            <img src="/frontend/web/sourse/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                            <div class="text">
